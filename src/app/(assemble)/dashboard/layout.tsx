          ...
          <div className="relative">
            {!profile?.thumbnail ? (
              ...
              <div
                ...
                style={{
                  backgroundImage: `url(${
                    profile?.thumbnail || "/images/mocks/college-cover.png"
                  })`,
                }}
              />
            )}
            ...
            <div className="absolute bottom-[-40px] left-6 size-[135px] rounded-full bg-[#D4D7E3] flex items-center justify-center border border-[#EBEDF0]">
              {!profile?.avatar ? (
                ...
                <div
                  ...
                  style={{
                    backgroundImage: `url(${
                      profile?.avatar || "/images/mocks/college-avatar.png"
                    })`,
                  }}
                />
              )}
          ...
          <div className="flex mt-12 items-center justify-between px-12">
            ...
            <div className="flex items-center gap-4">
              ...
              <button
                ...
                // disabled={isEmpty}
                className={`py-3 px-4 rounded-lg bg-primary text-white font-medium flex items-center gap-2.5 ${
                  isEmpty
