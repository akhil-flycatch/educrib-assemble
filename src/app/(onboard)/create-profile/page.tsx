...
router.push("/create-institute");  }
  ...
  return (
    <div className="flex flex-col gap-[2px] items-center">
       <p className=" font-semibold text-[28px] leading-[48.6px] tracking-[0.01em] text-center text-[#354764]">Let's set up your </p>
       <p className=" font-semibold text-[28px] leading-[48.6px] tracking-[0.01em] text-center text-[#354764]">admin profile</p>
